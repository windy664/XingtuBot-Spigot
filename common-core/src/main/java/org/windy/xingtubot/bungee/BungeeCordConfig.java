...
public class BungeeCordConfig implements BotConfig {
    ...
    public BungeeCordConfig(Path dataDir) {
        ...
        try {
            ...
            if (Files.exists(file)) {
                try (InputStream in = Files.newInputStream(file)) {
                    ...
                    if (obj instanceof Map) loaded = (Map<String, Object>) obj;
                }
            }
        } catch (IOException e) {
    ...
    public Map<String, String> getStringMap(String path) {
        ...
        if (val instanceof Map) {
            ...
            for (Map.Entry<?, ?> e : ((Map<?, ?>) val).entrySet()) {
                result.put(String.valueOf(e.getKey()).toLowerCase(), String.valueOf(e.getValue()));
            }
            return result;
        }
