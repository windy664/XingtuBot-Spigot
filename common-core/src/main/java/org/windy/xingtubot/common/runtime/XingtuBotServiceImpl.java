...
public class XingtuBotServiceImpl implements XingtuBotService {
    ...
    @Override
    public void registerCommand(org.windy.xingtubot.common.command.BotCommand command) {
        org.windy.xingtubot.common.handler.HandlerRegistry r = this.registry;
    ...
    public void setApiClient(org.windy.xingtubot.common.qq.QqOpenApiClient apiClient) {
    ...
    @Override
    public void beforeCommand(BiPredicate<String, ? super BotMessageEvent> hook) {
        if (hook != null) beforeHooks.add(hook);
    }

    @Override
    public void afterCommand(BiConsumer<String, ? super BotMessageEvent> hook) {
    ...
    public boolean fireBeforeCommand(String command, BotMessageEvent event) {
        boolean allow = true;
        for (BiPredicate<String, ? super BotMessageEvent> hook : beforeHooks) {
            try {
    ...
    public void fireAfterCommand(String command, BotMessageEvent event) {
        for (BiConsumer<String, ? super BotMessageEvent> hook : afterHooks) {
            try {
    ...
    public String getBotName() {
        return BotRuntimeState.getBotName();
    }

    @Override
    public boolean isDebugEnabled() {
        return BotRuntimeState.isDebugEnabled();
    }
}
