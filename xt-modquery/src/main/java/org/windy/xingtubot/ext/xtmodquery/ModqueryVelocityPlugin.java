...
/**
 * 模组查询+翻译扩展 · Velocity 主类。
 */
@Plugin(
        id = "xingtubot-modquery",
        name = "XingtuBot-Modquery",
        version = "2.2.1",
        authors = {"风吟"},
        dependencies = {
...
public class ModqueryVelocityPlugin {
    ...
    @Inject
    public ModqueryVelocityPlugin(ProxyServer proxy, Logger logger, @DataDirectory Path dataDir) {
        this.proxy = proxy;
        this.logger = logger;
    ...
    public void onProxyInit(ProxyInitializeEvent event) {
        ...
        module = ExtensionBootstrap.enable(host, new ModqueryModule(), config, botLogger, dataDir.toFile());
    }
