...
public class FunVelocityPlugin {
    ...
    @Inject
    public FunVelocityPlugin(ProxyServer proxy, Logger logger, @DataDirectory Path dataDir) {
        this.proxy = proxy;
        this.logger = logger;
    ...
    public void onProxyInit(ProxyInitializeEvent event) {
        ...
        module = ExtensionBootstrap.enable(host, new FunModule(), config, botLogger, dataDir.toFile());
    }
