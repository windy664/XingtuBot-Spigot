...
/**
 * GitHub 项目追踪扩展 · Velocity 主类。
 */
@Plugin(
        id = "xingtubot-github",
        name = "XingtuBot-Github",
        version = "2.2.1",
        authors = {"风吟"},
        dependencies = {
...
public class GithubVelocityPlugin {
    ...
    @Inject
    public GithubVelocityPlugin(ProxyServer proxy, Logger logger, @DataDirectory Path dataDir) {
        this.proxy = proxy;
        this.logger = logger;
    ...
    public void onProxyInit(ProxyInitializeEvent event) {
        ...
        module = ExtensionBootstrap.enable(host, new GithubModule(), config, botLogger, dataDir.toFile());
    }
