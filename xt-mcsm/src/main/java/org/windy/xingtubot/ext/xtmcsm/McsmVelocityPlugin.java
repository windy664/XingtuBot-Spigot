...
public class McsmVelocityPlugin {
    ...
    @Inject
    public McsmVelocityPlugin(ProxyServer proxy, Logger logger, @DataDirectory Path dataDir) {
        this.proxy = proxy;
        this.logger = logger;
    ...
    public void onProxyInit(ProxyInitializeEvent event) {
        ...
        module = ExtensionBootstrap.enable(host, new McsmModule(), config, botLogger, dataDir.toFile());
    }
